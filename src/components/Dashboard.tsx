        ...
        <ul className="mt-8 grid grid-cols-1 gap-6 divide-y divide-zinc-200 md:grid-cols-2 lg:grid-cols-3">
          {files.files
            ...
            .map((file) => (
              <li
                key={file._id}
                className="col-span-1 divide-y divide-gray-200 roudned-lg bg-white shadow transition hover:shadow-lg"
              >
                <Link
                ...
                <div className="px-6 mt-4 grid grid-cols-3 place-items-center py-2 gap-6 text-xs text-zinc-500">
                  ...
                  <Button
                    onClick={() => deleteFiles({ _id: file._id })}
                    size={"sm"}
                    className="w-full"
                    variant={"destructive"}
                  >
